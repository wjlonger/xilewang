...
import com.wuwei.consumer.wechat.hystric.XiLeWangActivityServiceHystric;
...
@FeignClient(value = "provider-wechat",configuration = FeignConfig.class, fallback= XiLeWangActivityServiceHystric.class, path = "/xilewang/activity")
